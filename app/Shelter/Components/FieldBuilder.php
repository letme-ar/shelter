...
class FieldBuilder {
    ...
    public function select($name,$label, $options, $value = null, $attributes = array())
    {
        return $this->input('select', $name,$label, $value, $attributes, $options);
    }
